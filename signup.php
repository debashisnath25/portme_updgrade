...
<div id="login_page">
	<div class="login_container">
		...
		<div class="login_success">
			<span class="icon"></span>Signup Successfully
		</div>
		...
		<form action="dashboard.html" method="get">
			...
			<input class="login_btn blue_lgel" name="" value="Signup" type="submit">
			<ul class="login_opt_link">
				<li><a href="forget_password.php">Forgot Password?</a></li>
