<div class="switch_bar">
		<ul class="ui-sortable" style="margin:5px;">
			...
			<li>
			<a href="clients.php"><span class="stats_icon user_sl"></span><span class="label">Clients</span></a>
			</li>
			...
			<!--<li><a href="#"><span class="stats_icon bank_sl"></span><span class="label">Archive</span></a></li>
